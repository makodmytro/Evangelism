    ...
    <div class="main-container">
        <div class="row w-100 mt-5 ms-0">
            ...
            <div class="col-lg-4 col-md-12 border border-1 border-solid px-4 pt-3 pb-3 mb-5 text-break">
                ...
                <div>
                    That my data will be stored and processed for the purpose of contacting me and for community work in
                    accordance with the statutory providsions on data protection. You can object to further processing
                ...
                <button name="submit" class="btn btn-primary mt-5 w-100" data-bs-toggle="modal"
                    data-bs-target="#exampleModal" type="submit">Register</button>
            </div>
        </div>
